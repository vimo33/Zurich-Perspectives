  ...
  useEffect(() => {
    async function loadPersona() {
      try {
        ...
        const foundPersona = data.personas.find(
          (p: Persona) => p.id === personaId
        )
        ...
        <div className="container mx-auto px-4 py-12">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        CHF {persona.income.toLocaleString()}
                      </p>
                    </div>
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="mb-6">
                Follow {persona.name}&apos;s journey through Zurich&apos;s
                economic and political systems. Discover how taxation, public
                spending, political influence, and voter engagement shape{" "}
                {persona.name}&apos;s experience of democracy.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="mb-6">
                See how {persona.name}&apos;s experience compares with others
                across the socioeconomic spectrum. Understanding these
                differences helps illustrate how economic inequality translates
                into political inequality in Zurich.
              </p>
