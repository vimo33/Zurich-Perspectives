...
export default function EngagementPage() {
  ...
  const renderTurnoutByEducationChart = useCallback(() => {
    ...
    const svg = d3
      .select("#turnout-education-chart")
      .append("svg")
      .attr("width", width)
      .attr("height", height)
      .append("g")
  ...
  const renderTurnoutByIncomeChart = useCallback(() => {
    if (!engagementData) return
  ...
  const renderPolicyAlignmentChart = useCallback(() => {
    if (!engagementData) return
    ...
    const data =
      engagementData.voterEngagement.representationEffects.policyAlignment
    const width = 500
    const height = 300
    const margin = { top: 20, right: 30, bottom: 40, left: 40 }
    const innerWidth = width - margin.left - margin.right
  ...
  const personaBarriers =
    engagementData.voterEngagement.participationBarriers[persona.id] || []
        ...
        <div className="container mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <p className="mb-8">
                This section explores how voter participation varies across
                different socioeconomic groups in Zurich. See how factors like
                education, income, and age affect democratic participation, and
                understand the barriers that {persona.name} might face when
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="mb-6">
                Education level is one of the strongest predictors of voter
                participation. In Zurich, those with tertiary education are more
                than twice as likely to vote as those with only primary
                education.
              </p>

              <div
                id="turnout-education-chart"
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="mb-6">
                Income level strongly correlates with voter participation.
                High-income residents in Zurich are twice as likely to vote as
                low-income residents, creating a significant representation gap.
                {persona.id === "anna"
            ...
            <div className="p-4 bg-[#F1FAEE] rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-2">
                {persona.id === "anna" ? (
                  <>
                    <li>
                      <strong>Federal Elections:</strong> Votes in most federal
                      elections
                    </li>
                    <li>
                      <strong>Cantonal Elections:</strong> Votes in some
                      cantonal elections
                    </li>
                    <li>
                      <strong>Referendums:</strong> Participates in
                      approximately half of referendums
                    </li>
                    <li>
                      <strong>Local Politics:</strong> Limited engagement with
                  ...
                  <>
                    <li>
                      <strong>Federal Elections:</strong> Votes occasionally in
                      major federal elections
                    </li>
                    <li>
                      <strong>Cantonal Elections:</strong> Rarely votes in
                      cantonal elections
                    </li>
                    <li>
                      <strong>Referendums:</strong> Participates in few
                      referendums
                    </li>
                    <li>
                      <strong>Local Politics:</strong> Minimal engagement with
                      local political issues
                    </li>
                  </>
                ) : (
                  <>
                    <li>
                      <strong>Federal Elections:</strong> Votes consistently in
                      federal elections
                    </li>
                    <li>
                      <strong>Cantonal Elections:</strong> Votes regularly in
                      cantonal elections
                    </li>
                    <li>
                      <strong>Referendums:</strong> Participates in most
                      referendums
                    </li>
                    <li>
                      <strong>Local Politics:</strong> Active engagement with
                      local political issues
                    </li>
                  </>
                )}
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 mb-12">
            ...
            <p className="mb-6">
              Differential turnout by socioeconomic status creates a
              &quot;participation gap&quot; that skews democratic
              representation. Research shows that policies tend to align more
              closely with the preferences of higher-income voters who
              participate at higher rates.
            </p>

            <div
              id="policy-alignment-chart"
              className="flex justify-center items-center h-80 mb-6"
            ></div>

            <div className="p-4 bg-[#F1FAEE] rounded-lg mb-6">
              <h4 className="font-semibold mb-2">Key Research Findings:</h4>
              <ul className="list-disc pl-5 space-y-2">
                {engagementData.voterEngagement.representationEffects.keyFindings.map(
                  (finding, index) => (
            ...
            <div className="p-4 border border-[#1D3557] rounded-lg">
              <h4 className="font-semibold mb-2">
                What This Means for {persona.name}:
              </h4>
              <p>
                {persona.id === "anna"
